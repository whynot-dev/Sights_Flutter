...
import 'package:sights/domain/entities/notifications_section.dart';
...
class NotificationsSection extends StatelessWidget {
  ...
  final NotificationsSectionEntity notificationsSection;
  ...
  String _calculateDate(context) {
    ...
    final date = notificationsSection.date;
  ...
  Widget _buildNotifications(context) => ListView.separated(
        shrinkWrap: true,
        padding: const EdgeInsets.symmetric(horizontal: 16),
        physics: NeverScrollableScrollPhysics(),
        itemCount: notificationsSection.notifications.length,
        itemBuilder: (context, index) => _buildCard(context, notificationsSection.notifications[index]),
        separatorBuilder: (context, index) => const SizedBox(height: 12),
      );

  Widget _buildCard(context, NotificationEntity notification) => Container(
